...
const HERO_SLIDES = {
  en: [
    ...
    {
      badge:   '🔗 Channel Manager · Booking.com · Expedia · Airbnb · Direct',
      line1:   'Sync Your Rooms to',
      line2:   'Every OTA in Real-Time',
      sub:     'Connect Booking.com, Expedia, Airbnb, and your direct website in minutes. iHotel exports a live iCal feed and receives bookings automatically — zero double-bookings, zero manual sync.',
  ...
  ar: [
    ...
    {
      badge:   '🔗 مدير القنوات · Booking.com · Expedia · Airbnb · مباشر',
      line1:   'زامن غرفك مع',
      line2:   'كل OTA في الوقت الفعلي',
      sub:     'صِل Booking.com وExpedia وAirbnb وموقعك المباشر في دقائق. تصدّر iHotel خلاصة iCal حية وتستقبل الحجوزات تلقائياً — صفر حجوزات مزدوجة، صفر مزامنة يدوية.',
      accent:  'from-rose-300 via-pink-300 to-fuchsia-300',
      mockup:  'pms',
      dot:     'bg-rose-400',
    },
...
const T = {
  en: {
    ...
    features: [
      ...
      { title: 'Channel Manager',          desc: 'Live iCal feed + webhook receiver syncs availability to Booking.com, Expedia, Airbnb, and your direct site.', result: '0 double-bookings' },
      { title: 'Upsell Engine',            desc: 'Guests browse and request extras (breakfast, transfer, minibar) from the portal. Staff fulfil with one tap.', result: '+15–25% RevPAR' },
    ...
    ctaSub: 'Join hotel operators running smarter, greener, and more profitable properties with iHotel. Real-time IoT. Guest portal. Channel Manager. Upsell Engine. All in one platform.',
  ...
  ar: {
    ...
    features: [
      ...
      { title: 'مدير القنوات',              desc: 'خلاصة iCal حية + استقبال Webhook يزامن التوافر مع Booking.com وExpedia وAirbnb وموقعك المباشر.', result: 'صفر حجوزات مزدوجة' },
      { title: 'محرك الخدمات الإضافية',    desc: 'يتصفح الضيوف الإضافات (إفطار، نقل، ميني بار) من البوابة. يستجيب الموظف بنقرة واحدة.', result: '+15-25% RevPAR' },
    ...
    ctaSub: 'انضم لمشغّلي الفنادق الذين يديرون منشآت أكثر ذكاءً وكفاءةً وربحيةً. IoT فوري، بوابة ضيف، مدير القنوات، محرك الخدمات الإضافية — كل ذلك في منصة iHotel الواحدة.',
